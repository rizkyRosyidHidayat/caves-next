  ...
  const best_values = [
    ...
    <div 
      ...
      className={`
        ...
        ${value.title==='Share'?'sm:col-span-3':'sm:col-span-4'}
      `}>
      {/* eslint-disable */}
      <img src={`/assets/${value.img}`} alt={value.img} width="80" className="mx-auto sm:mx-0" />
      {/* eslint-enable */}
    ...
    <div>
      ...
      <main>
          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-20">
              <div className="text-center sm:text-left">
                <div className="text-xl sm:text-2xl mb-3">VR Social Browsing</div>
                <h1 className="uppercase text-7xl sm:text-banner font-heading leading-tight" style={{ fontWeight: 'bold', letterSpacing: 0 }}>
        ...
        <section className="mt-24 sm:mt-32">
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 sm:gap-20 items-center">
              ...
              <div className="text-center sm:text-left">
                <h2 className="font-heading leading-tight text-6xl sm:text-7xl mb-3" style={{ fontWeight: 'bold' }}>
                  OUR <br />
        ...
        <section className="mt-32 sm:mt-40">
          <div className="container px-6 sm:px-28">
            <h2 className="font-heading leading-tight text-center sm:text-left text-6xl sm:text-7xl mb-3" style={{ fontWeight: 'bold' }}>
              OUR <br />
              <span className="text-primary-100">
                BEST VALUE
              </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-11 gap-8 mt-5">
              { best_values }
            </div>
        ...
        <section className="mt-40">
          <div className="container">
            <div 
              className="flex items-center bg-cover px-0 sm:px-40 bg-shape">
              <div>
                <h1 className="text-center uppercase font-heading text-6xl text-white leading-tight sm:leading-1" style={{ fontWeight: 'bold' }}>
